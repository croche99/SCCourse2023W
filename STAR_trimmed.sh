...
STAR --runThreadN 16 --genomeDir /scratch/course/2023w300106/rochearcas/genome/ncbi_dataset/data/GCF_932526225.1/jaNemVect1.1_STAR \
	--readFilesIn /scratch/course/2023w300106/rochearcas/rawreads/trimmed_reads/SRR24348405_R1.fastq /scratch/course/2023w300106/rochearcas/rawreads/trimmed_reads/SRR24348405_R2.fastq \
	--outSAMtype BAM SortedByCoordinate --twopassMode Basic \
	--outSAMstrandField intronMotif --outFileNamePrefix SRR24348405_trimmed
